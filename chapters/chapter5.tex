...
Toisessa funktiokutsussa \code{int}-funktiolle syötetään arvo \code{2}, minkä seurauksena se tulkitsee merkkijonon \code{"10"} 2-järjestelmässä eli biäärijärjestelmässä. Oletuksena argumentin arvo on \code{10}, jolloin luku tulkitaan kymmenjärjestelmää käyttäen.
